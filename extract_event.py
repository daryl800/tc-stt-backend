...
def extract_event_info(text):
    prompt_system = (
        ...
        "今天是：{today}, 請根據這個日期準確计算「聽日」「tomorrow」「next Wednesday」「下星期三」等相對日期, 如果句子是中英混合，例如「remind me 下個星期五」，也請正確理解並處理。\n"
        "今天是：{today}，如果今天是6月6日，下星期三就是6月11日， 也請正確理解并推算。\n"
        "请注意，广东话，呢个星期三系指这个星期三，如果今天是星期三，呢个星期三就系今日。\n"
        "请注意，广东话，听日系指明天，如果今天是星期五，听日就是星期六。\n"
        "请注意，广东话，后日系指明天的明天，如果今天是星期五，后日或者后天就是星期日。\n"
        "今天是：{today}，如果今天是6月6日，今日系星期五，呢个星期日就系6月8日。\n"
        "今天是：{today}，如果今天是6月6日，今日系星期五，呢个星期六就系6月7日。\n"
        ...
        "2. reminderDatetime：事件的時間（ISO 8601 格式，精確至分鐘，例如 2025-06-06T08:30），若無明確時間，預設為當天中午12:00。\n"
        ...
        # "  \"reminderDatetime\": \"2025-06-06T08:30\",\n"
        # "  \"location\": [\"佛山\", \"中山\"],\n"
        # "  \"isReminder\": true\n"
        # "}\n\n"
